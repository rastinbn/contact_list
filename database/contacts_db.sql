...
--
-- Table structure for table `contact_shares`
--
...
CREATE TABLE `contact_shares` (
  ...
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  PRIMARY KEY (`contact_id`, `shared_with_user_id`),
...
--
ALTER TABLE `contact_social_media`
  ADD CONSTRAINT `contact_social_medi-ibfk_1` FOREIGN KEY (`contact_id`) REFERENCES `contacts_info` (`id_contact`) ON DELETE CASCADE;

--
-- Constraints for table `contact_shares`
--
ALTER TABLE `contact_shares`
  ADD CONSTRAINT `contact_shares_ibfk_1` FOREIGN KEY (`contact_id`) REFERENCES `contacts_info` (`id_contact`) ON DELETE CASCADE,
  ADD CONSTRAINT `contact_shares_ibfk_2` FOREIGN KEY (`shared_with_user_id`) REFERENCES `contacts_user` (`id`) ON DELETE CASCADE;
COMMIT;
